...
public class Tir extends Camion {

	private TipCamion tipCamion = TipCamion.tir;
	private double tonaj;

	@SuppressWarnings("resource")
	public Tir(String marca, String model, TipAutovehicol tip, TipCamion tipCamion) {
	...
	public Tir(String marca, String model, TipAutovehicol tip) {
		super(marca, model, tip);
	}
